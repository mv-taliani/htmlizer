...
def _(dictio: dict, sep='=') -> str:
    return " ".join(f'{prop}{sep}{value if not isinstance(value, dict) else htmlize(value, sep=":")}' for prop, value
                    in dictio.items())
...
if __name__ == '__main__':
    ...
    @app.route('/')
    def _():
        return "<br>".join(htmlize(i) for i in [TesteForm(), 'Batatinhas', (1, 2, 4, 5, 6,), {'aiaiai': 'bb'}, 5])
